...
urlpatterns = [
    ...
    path('done-generate-new-password/', UserForgotPasswordEmailView.as_view(), name='passw_refresh'),
    ...
    path('success/', RedirectView.as_view(pattern_name='users:payment-create'), name='stripe-success'),
